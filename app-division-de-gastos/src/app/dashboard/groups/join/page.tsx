    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-zinc-50 p-4">
            <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl ring-1 ring-zinc-200">
                ...
                <form action={joinGroupWithCode} className="flex flex-col gap-6">
                    <div>
                    ...
                    <div className="flex gap-3 mt-2">
                        ...
                        <button
                            ...
                            className="flex-1 rounded-xl bg-indigo-600 px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm shadow-indigo-100 hover:shadow-md"
                        >
                            Unirse al Grupo
                        </button>
                    </div>
